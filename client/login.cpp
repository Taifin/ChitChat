...
void login::show_login_window() { this->show(); }
...
void login::no_user() { ui->information_label->setText("User is not found"); }

void login::error() { ui->information_label->setText("Something go wrong"); };
