...
main_window::main_window(QWidget *parent)
  ...
  connect(&processor, SIGNAL(run_change_position(std::string, int, int)), this,
          SLOT(change_position(std::string, int, int)));
  ui->setupUi(this);
  this->setWindowTitle("ChitChat");
}

void main_window::start() { login_m.show(); }

void main_window::show_after_auth() { this->show(); };

main_window::~main_window() { delete scene; }
